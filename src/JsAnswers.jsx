...
const JsAnswers = () => {
    ...
    return (
        <div >
            <h2 className='text-center text-md'> 1. Please open console to see the "6 JS related " results</h2>
            <h2 className='text-center text-md'> 2. output for SS1 and SS2 are bellow:</h2>
        </div>
    )
}
